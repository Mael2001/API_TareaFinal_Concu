...
namespace API.SignalR.Service
{
    public class Worker : BackgroundService
    {
        ...
        public Worker(ILoggerFactory loggerFactory, IHubContext<ChatHub> hub)
        {
            _hub = hub;
        ...
        private void HandleMessage(string content)
        {
            ...
            _hub.Clients.All.SendAsync("ReceiveMessage", "master",content);
        }
